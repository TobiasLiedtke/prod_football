...
def get_results():
    #define global dataframe (can be used in upload functions)
    global df_results
    ...
    df = Results.get_results_premierleague(saison, spieltag)
...
def upload_results():
    ...
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_staging_ergebnisse', saison, spieltag)
...
def get_results_cat():
    ...
    df = Results.categorisation_premier_league(saison, spieltag)
...
def upload_results_cat():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_data_ergebnisse_kategorisiert', saison, spieltag)    
...
def get_fifa_data():
    ...
    df = ff.get_fifa_features_premierleague(saison, spieltag, url)
...
def upload_fifa_upload():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_staging_vereine_fifa_features', saison, spieltag)    
...
def upload_formfeatures():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_features_club_form', saison, spieltag)
...
def upload_formfeatures_forecast():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_features_forecast_club_form', saison, spieltag)
...
def upload_staging_football_gov():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_staging_football_uk', saison, spieltag)
...
def upload_data_gov():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_data_vereine_data_gov', saison, spieltag)
...
def upload_data_odds_gov():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_data_vereine_bookmaker_odds', saison, spieltag)
...
def upload_data_features():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_features_club_data', saison, spieltag)
...
def upload_data_features_forecast():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_features_forecast_club_data', saison, spieltag)
...
def upload_club_value():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_data_vereine_kader_wert', saison, spieltag)
...
def get_opponent_features():
    ...
    df = Results.get_opponent_stat_premierleague(spieltag, saison)
    df_data_opponent = df_data_opponent.append(df)
    print("done") 

def check_opponent_features():
    if len(df_data_opponent)==20:
        print("Everything fine")
    else:
        print("Problem")
...
def upload_opponent_features():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_feature_opponent_statistic', saison, spieltag)
    db.upload_local_data_to_database(df_data_opponent, 'pl_feature_opponent_statistic')
    print("Data successfuly uploaded") 
...
def get_opponent_features_forecast():
    ...
    df = Results.get_opponent_statistic_forecast_premierleague(spieltag, saison)
...
def check_opponent_features_forecast():
    if len(df_opponent_features_forecast)==20:
        print("Everything fine")
    else:
        print("Problem")
...
def upload_opponent_features_forecast():
    spieltag = int(entry_spieltag.get())
    saison = entry_saison.get()
    db.delete_table_saison_spieltag('pl_feature_opponent_statistic_forecast', saison, spieltag)
    db.upload_local_data_to_database(df_opponent_features_forecast, 'pl_feature_opponent_statistic_forecast')
    print("Data successfuly uploaded") 
...
button_club_form.place(relx = 0.35, rely =  0.25, relwidth = 0.15, relheight = 0.05)
button_club_form_check.place(relx = 0.35, rely =  0.3, relwidth = 0.15, relheight = 0.05)
button_club_form_upload.place(relx = 0.35, rely =  0.35, relwidth = 0.15, relheight = 0.05)

button_club_Forecast.place(relx = 0.5, rely =  0.25, relwidth = 0.15, relheight = 0.05)
button_club_Forecast_check.place(relx = 0.5, rely =  0.3, relwidth = 0.15, relheight = 0.05)
button_club_Forecast_upload.place(relx = 0.5, rely =  0.35, relwidth = 0.15, relheight = 0.05)

button_fifa.place(relx = 0.65, rely =  0.25, relwidth = 0.15, relheight = 0.05)
button_fifa_check.place(relx = 0.65, rely =  0.3, relwidth = 0.15, relheight = 0.05)
button_fifa_upload.place(relx = 0.65, rely =  0.35, relwidth = 0.15, relheight = 0.05)

button_club_value.place(relx = 0.8, rely =  0.25, relwidth = 0.15, relheight = 0.05)
button_club_value_day_check.place(relx = 0.8, rely =  0.3, relwidth = 0.15, relheight = 0.05)
button_club_value_upload.place(relx = 0.8, rely =  0.35, relwidth = 0.15, relheight = 0.05)
#second row
...
button_opponent_features.place(relx =  0.05, rely = 0.65, relwidth = 0.15, relheight = 0.05)
button_opponent_features_check.place(relx =  0.05, rely = 0.7, relwidth = 0.15, relheight = 0.05)
button_opponent_features_upload.place(relx =  0.05, rely = 0.75, relwidth = 0.15, relheight = 0.05)

button_opponent_features_forecast.place(relx =  0.2, rely = 0.65, relwidth = 0.15, relheight = 0.05)
button_opponent_features_forecast_check.place(relx =  0.2, rely = 0.7, relwidth = 0.15, relheight = 0.05)
button_opponent_features_forecast_upload.place(relx =  0.2, rely = 0.75, relwidth = 0.15, relheight = 0.05)
root.mainloop()
